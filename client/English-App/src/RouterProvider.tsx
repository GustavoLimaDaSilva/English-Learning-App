...
import type { ProfileData, StateSetter } from './types/index.ts';
            ...
            children: [
                ...
                // },
                {
                    ...
                    loader: async () => {
                        ...
                        const raw = await fetch(`https://api-o37g4y27ua-uc.a.run.app/users/${user.uid}`)
                    ...
                    children: [
                        {
                            ...
                            loader: async () => {
                                ...
                                const raw = await fetch('https://api-o37g4y27ua-uc.a.run.app/lessons')
                        ...
                        },
                        {
                            ...
                            loader: async ({ params }) => {
                                ...
                                const id = params.id
                                const raw = await fetch(`https://api-o37g4y27ua-uc.a.run.app/lessons/${id}`)
                        ...
                        // },
                        {
                            ...
                            loader: async () => {
                                const raw = await fetch(`https://api-o37g4y27ua-uc.a.run.app/decks/${user?.uid}?level=${profileData.level}`)
                                const data = await raw.json()
                                return data
                            },
                            children: [
                                ...
                                },
                                {
                                    ...
                                    loader: async ({ params }) => {
                                        ...
                                        const id = params.id
                                        const raw = await fetch(`https://api-o37g4y27ua-uc.a.run.app/decks/${id}`)
